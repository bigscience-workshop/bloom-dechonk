...
class TrainerWithSubsetEval(transformers.trainer.Trainer if src.overrides.Trainer is None else src.overrides.Trainer):
    ...
    def evaluate(self, eval_dataset=None, **kwargs):
        ...
        assert isinstance(eval_dataset, WrappedIterableDataset), type(eval_dataset)
        return super().evaluate(eval_dataset.take_next_subset(self.eval_subset_size), **kwargs)
...
def main():
    ...
    if training_args.do_train:
        ...
        print("!!"*5, checkpoint, last_checkpoint, training_args.resume_from_checkpoint)
